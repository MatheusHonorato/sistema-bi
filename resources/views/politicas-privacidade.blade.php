...
<div id="quem-somos" class="py-24">
  ...
  <div class="container max-w-xl mx-auto flex items-start flex flex-col">
    <div class="p-10 bg-white">
        ...
        <p class="mb-5 text-justify">Por isso, esta presente Política de Privacidade estabelece como é feita a coleta, uso e transferência de informações de clientes ou outras pessoas que acessam ou usam nosso site, formulários digitais e/ou ferramentas digitais desenvolvidas.</p>

        <p class="mb-5 text-justify">Ao utilizar nossos serviços, você entende que coletaremos e usaremos suas informações pessoais nas formas descritas nesta Política, sob as normas da Constituição Federal de 1988 (art. 5º, LXXIX; e o art. 22º, XXX – incluídos pela EC 115/2022), das normas de Proteção de Dados (LGPD, Lei Federal 13.709/2018), das disposições consumeristas da Lei Federal 8078/1990 e as demais normas do ordenamento jurídico brasileiro aplicáveis.</p>
...
comprovar sua identidade. Nessa hipótese, você será informado previamente.</p>
        ...
        <ol class="list-decimal">
          ...
          <ol class="list-decimal">
            ...
            pela segurança dos processos de tratamento de dados e do cumprimento das finalidades
            descritas no presente instrumento.

            Destacamos que a responsabilidade em relação à confidencialidade dos dados de acesso é do
            usuário.
            </li>
            <li>Ações maliciosas de terceiros, como ataques de hackers, exceto se comprovada conduta
            culposa ou deliberada da Rebrax Assessoria.
            ...
            afetados e a Autoridade Nacional de Proteção de Dados sobre o ocorrido e cumpriremos as
            providências necessárias.
            </li>
            <li>Inveracidade das informações inseridas pelo usuário/cliente nos registros necessários
            para a utilização dos serviços da Rebrax Assessoria; quaisquer consequências decorrentes de
          ...
          <p class="text-justify">A Rebrax Assessoria agradece pela sua atenção.</p>
      </div>
  </div>
